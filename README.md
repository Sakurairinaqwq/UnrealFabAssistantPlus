...
简体中文 | [English]([https://www.google.com/search?q=/doc/README_EN.md](https://github.com/Sakurairinaqwq/UnrealFabAssistantPlus/blob/main/doc/README_EN.md))
...
* **自动语言检测**：不再需要手动选择语言，脚本会自动识别浏览器语言设置（中/英）。


* **🚀 多渠道 & 双模式**：支持 Unreal Engine, Unity, UEFN, MetaHuman 渠道；支持“快速模式”（仅看新品）和“全量模式”（地毯式搜索）。
...
<p align="center">感谢使用 UnrealFabAssistantPlus v3.6.0！</p>
